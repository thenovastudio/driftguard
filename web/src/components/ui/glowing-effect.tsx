      ...
      >
        <div
          className={cn(
            ...
            "after:[-webkit-mask:linear-gradient(#0000,#0000),conic-gradient(from_calc((var(--start)-var(--spread))*1deg),#00000000_0deg,#fff,#00000000_calc(var(--spread)*2deg))]",
        ...
        >
          <div
            className={cn(
              ...
              "[border:var(--glowingeffect-border-width)_solid_transparent]",
